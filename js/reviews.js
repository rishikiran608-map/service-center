...
const SEED_REVIEWS = [
  {
    ...
    name: 'Rajesh Kumar',
    rating: 5,
    comment: 'Excellent service! My LG front-load washing machine was making a terrible noise. The technician diagnosed the drum bearing issue in minutes and fixed it same day. Very professional and transparent about the cost. Highly recommend!',
  ...
  },
  {
    ...
    name: 'Priya Reddy',
    rating: 5,
    comment: 'AC stopped cooling in peak summer — these guys came within 2 hours! Gas refill done perfectly, and they also cleaned the filters at no extra charge. Great service, very honest pricing. My go-to for all appliance issues.',
    appliance: 'AC Repair',
    photo: 'images/service-ac-repair.png',
    date: '2026-05-28',
  },
  {
    id: 'seed_3',
    ...
    rating: 4,
    comment: 'Got my refrigerator compressor replaced. They used genuine parts and gave a 90-day warranty on the repair. The technician explained everything clearly. Slightly delayed on the first visit but overall very good experience.',
    appliance: 'Refrigerator',
    photo: 'images/service-refrigerator.png',
    date: '2026-05-10',
  },
  {
    id: 'seed_4',
    name: 'Lakshmi Devi',
    rating: 5,
    comment: 'IFB washing machine installation done perfectly. The team was punctual, neat, and showed us how to use all the settings. They even advised on the best detergent to use for the machine. 5 stars without hesitation!',
  ...
  },
  {
    ...
    name: 'Suresh Babu',
    rating: 5,
    comment: 'Signed up for their AMC plan for both my AC and washing machine. Best decision — two free services, priority response, and 15% discount on parts. Saved a lot compared to paying per visit. Very trustworthy team.',
    appliance: 'AMC',
  ...
  },
  {
    ...
    name: 'Anitha Sharma',
    rating: 4,
    comment: 'My double-door refrigerator was not cooling one section. Diagnosed as a faulty thermostat. Fixed in about 45 minutes with a genuine part. Fair pricing and no hidden charges. Will definitely call them again.',
    appliance: 'Refrigerator',
